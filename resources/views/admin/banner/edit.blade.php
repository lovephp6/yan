    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $cate_one->pic_name }}" placeholder="" id="username" name="pic_name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="cate">
					<option value="" selected>请选择分类</option>
                    @foreach($cates as $cate)
                        <option value="{{ $cate->id }}" @if($cate_one->cate == $cate->id) selected  @endif>{{ $cate->cate_name }}</option>
                    @endforeach
				</select>
				</span> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" value="{{ $cate_one->status }}" placeholder="" id="mobile" name="status">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">排序：</label>
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="sort" id="email" value="{{ $cate_one->sort }}">
            </div>
        </div>
