    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $dian->dian_title }}" placeholder="" id="username" name="dian_title">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $dian->dian_address }}" placeholder="" name="dian_address">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">店铺电话：</label>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $dian->dian_tel }}" placeholder="" name="dian_tel">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="btn-upload form-group">
				<input class="input-text upload-url" type="text" name="url" id="uploadfile" readonly nullmsg="请添加附件！" style="width:200px">
				<a href="javascript:void();" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a>
				<input type="file" multiple name="file2" class="input-file" value="{{ $dian->dian_code }}">
				</span> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="status" value="{{ $dian->status }}" >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">排序：</label>
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="sort" value="{{ $dian->sort }}">
            </div>
        </div>
