...
<head>
    ...
    <![endif]-->
    <title>建材列表</title>
    <link rel="stylesheet" href="{{ url('lib/zTree/v3/css/zTreeStyle/zTreeStyle.css') }}" type="text/css">
</head>
<body class="pos-r">
<div>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分店管理 <span class="c-gray en">&gt;</span> 分店列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <div class="text-c"> 日期范围：
            ...
            <button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜店铺</button>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加分店','{{ url('dian/add') }}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分店</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                @foreach($dians as $dian)
                    <tr class="text-c va-m">
                        ...
                        <td>{{ $dian->status }}</td>
                        <td class="td-status">{{ $dian->sort }}</td>
                        <td class="td-manage"><a style="text-decoration:none" class="ml-5"  href="{{ url('dian/edit', $dian->id) }}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'{{ url('dian/delete', $dian->id) }}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
