    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $teacher->name }}" placeholder="" id="username" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">上班时间：</label>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $teacher->s_work }}" placeholder="填写时间(格式20:00)" id="s_work" name="s_work">
         </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $teacher->x_work }}" placeholder="填写时间(格式20:00)" id="x_work" name="x_work">
            </div>
		<span style="color:red;font-size: 12px;">此处填写时间格式(20:00)</span>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $teacher->title }}" placeholder="" name="title">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="sort" value="{{ $teacher->sort }}">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="desc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)">{{ $teacher->desc }}</textarea>
