            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{ $cate->cate_name }}" placeholder="请输入图片显示位置名称(例如：首页轮播图)" id="" name="cate[cate_name]">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                        <div class="radio-box">
                            <input name="cate[status]" type="radio" id="sex-1" @if ($cate->status==1) checked @endif value="1">
                            <label for="sex-1">显示</label>
                        </div>
                        <div class="radio-box">
                            <input type="radio" id="sex-2" name="cate[status]" value="2" @if ($cate->status==2) checked @endif>
