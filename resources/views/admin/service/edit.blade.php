    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ $service->service_name }}" placeholder="" id="username" name="service_name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="status" value="{{ $service->status }}" >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">排序：</label>
            <div class="formControls col-xs-1 col-sm-1">
                <input type="text" class="input-text" placeholder="" name="sort" value="{{ $service->sort }}">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="service_jianjie" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,800)">{{ $service->service_jianjie }}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="service_desc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,800)">{{ $service->service_desc }}</textarea>
