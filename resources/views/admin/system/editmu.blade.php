			...
			@include('layouts/errors')
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{ $cate->fuwu }}" placeholder="请输入图片项目名称" id="" name="xm[fuwu]">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                ...
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                        ...
                        服务时长：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{ $cate->fuwu_time }}" placeholder="请输入图片项目名称" id="" name="xm[fuwu_time]">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-2 col-sm-2">
                        <input type="text" class="input-text" value="{{ $cate->money }}"  id="" name="xm[money]">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
