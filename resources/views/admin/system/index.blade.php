    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ empty($sysMsg->name) ? '' : $sysMsg->name }}" placeholder="" id="username" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ empty($sysMsg->address) ? '' : $sysMsg->address }}" placeholder="" id="username" name="address">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ empty($sysMsg->tel) ? '' : $sysMsg->tel }}" placeholder="" id="username" name="tel">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">店铺邮箱：</label>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="{{ empty($sysMsg->email) ? '' : $sysMsg->email }}" placeholder="" id="username" name="email">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="desc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,800)">{{ empty($sysMsg->desc) ? '' : $sysMsg->desc }}</textarea>
